class PlanMetrajeTL {
  ...
  factory PlanMetrajeTL.fromJson(Map<String, dynamic> json) {
    return PlanMetrajeTL(
      planMetrajeTlId: _asInt(json['planMetrajeTlId']) ?? 0,
  ...
  Map<String, dynamic> toMap() {
    return {
      'planMetrajeTlId': planMetrajeTlId,
      'labor_id': laborId,
