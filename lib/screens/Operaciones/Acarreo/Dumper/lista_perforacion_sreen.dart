...
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/DialogoChecklistTelemando.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/DialogoProgramaTrabajo.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/dialog_check_imagen.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/dialogo_checklist.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/dialogo_condiciones_equipo.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/dialogo_confirmar_cierre.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/dialogo_formulario_perforacion.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/dialogo_horometro.dart';
import 'package:i_miner/screens/Operaciones/Acarreo/Dumper/widgets/dialogo_no_operativo_formulario_perforacion.dart';
...
class TaladroDumperScreen extends StatefulWidget {
  final String? rolUsuario;
  final String? dniUsuario;

  const TaladroDumperScreen({Key? key, this.rolUsuario, this.dniUsuario})
    : super(key: key);

  @override
  State<TaladroDumperScreen> createState() => _TaladroDumperScreenState();
}

class _TaladroDumperScreenState extends State<TaladroDumperScreen> {
  ...
  Future<void> _cargarEstadosOperacion() async {
    ...
    List<Map<String, dynamic>> estados = await DatabaseHelper()
        .getEstadosByOperacionIdDumper(operacionId!);
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                OperacionCard(
                  ...
                  selectedOperatorName: _isMaster
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      int filasAfectadas = await DatabaseHelper()
                          .eliminarOperacionTalDumperFisico(operacionId!);
  ...
  Future<void> _actualizarRegistroEstado(
    ...
    try {
      ...
      if (actualizado) {
        ...
        todosLosEstados = await DatabaseHelper().getEstadosByOperacionIdDumper(
          operacionActual!['id'],
        );
  ...
  Future<List<Map<String, dynamic>>> _getOperaciones() async {
    if (operacionActual == null) return [];
    return await DatabaseHelper().getEstadosByOperacionIdDumper(
      operacionActual!['id'],
    );
  }
  ...
  Future<void> _editarOperacionOperativoDumper(
    ...
    Map<String, dynamic> datos = await DatabaseHelper()
        .getOperacionByEstadoIdDumper(operacionActual!['id'], operacion['id']);
  ...
  void _handleChecklistTelemando() async {
    ...
    List<Map<String, dynamic>> checklistTelemandoData = await DatabaseHelper()
          ...
          onConfirmar: () async {
            ...
            try {
              ...
              List<Map<String, dynamic>> todosLosEstados =
                  await DatabaseHelper().getEstadosByOperacionIdDumper(
                    operacionActual!['id'],
                  );
              ...
              await DatabaseHelper().cerrarOperacionDumper(
                operacionActual!['id'],
              );
