        ...
        if (isSmallScreen) ...[
          ...
          if (!isOrigenSeleccionado) ...[
            _buildCompactDropdownField(
              ...
              onChanged: (tipoLaborInicioSeleccionado != null && isEditable && !isOrigenSeleccionado) 
                  ? (value) {
                      setState(() {
            ...
            _buildCompactDropdownField(
              ...
              onChanged: (laborInicioSeleccionado != null && isEditable && !isOrigenSeleccionado) 
                  ? (value) {
                      setState(() {
