...
class OperacionScissorCard extends StatefulWidget {
  ...
  @override
  State<OperacionScissorCard> createState() => _OperacionScissorCardState();
}

class _OperacionScissorCardState extends State<OperacionScissorCard> {
  ...
  Future<void> _cargarEquipos() async {
    try {
      ...
      // 🔥 IMPORTANTE: Filtrar por proceso SCISSOR
      String tipoOperacion = 'SCISSOR';
      ...
      print('Equipos SCISSOR cargados: ${equipos.length}');
    } catch (e) {
  ...
  @override
  void didUpdateWidget(covariant OperacionScissorCard oldWidget) {
