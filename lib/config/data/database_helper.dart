...
class DatabaseHelper {
  ...
  static const int _currentDbVersion = 20;
...
Future<Map<String, dynamic>?> createEstado(
  ...
  Map<String, dynamic> operacionCompleta = {
    ...
    'metros_perforados_produccion': operacion?['metros_perforados_produccion'] ?? '',
    'n_taladros_rimados': operacion?['n_taladros_rimados'] ?? '',
    'metros_perforados_rimados': operacion?['metros_perforados_rimados'] ?? '',
...
Future<Map<String, dynamic>> getOperacionByEstadoId(int operacionId, int estadoId) async {
  final db = await database;
